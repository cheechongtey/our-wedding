  ...
  dressCode: [
    {
      level: "Smart Casual",
      description:
        "Dresses, skirts, slacks, or button-up shirts are perfect.",
    },
    {
      level: "Formal Attire",
      description:
        "Tuxedos for men and gowns or cocktail dresses for women are appreciated.",
    },
    {
      level: "Black Tie",
      description:
        "Tuxedos for men and elegant gowns for women are the ideal choice.",
    },
  ],
